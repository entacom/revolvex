  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="?p=admin_job_search">
...
<div id="site_message"></div>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="?p=super_admin_profile">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
		...
		<li class="nav-item">
        <a class="nav-link collapsed" href="?p=super_admin_subscriptions">
          <i class="bi bi-person"></i>
