 ...
 <!-- ======= Sidebar for Clients ======= -->
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="?p=vendor_dashboard&s=dashboard">
	 ...
	 <li class="nav-item">
        <a class="nav-link collapsed" href="?p=vendor_dashboard&s=documents">
	  ...
	  <li class="nav-item">
		...
		<li class="nav-item">
        <a class="nav-link collapsed" href="?p=vendor_dashboard&s=messages">
          <i class="bi bi-file-earmark"></i>
          <span>Messages</span>
        </a>
      </li><!-- End Profile Page Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="?p=vendor_dashboard&s=help">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="?p=vendor_dashboard&s=contact">
