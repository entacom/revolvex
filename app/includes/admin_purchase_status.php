<script type="text/javascript" src="includes_pages/admin_purchase_status/script.js?n=<?php echo date('h:i');?>"></script>
<main id="main" class="main">
    <div class="card border-0">
        <div class="card-body">
            <h4 class="card-title" id="company_name_text">Purchase Status</h4>
