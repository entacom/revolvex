...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        if (!$this->header_displayed) { // Only display the header on the first page
            ...
            $this->Cell(0, 15, 'Delivery Docket', 0, false, 'R', 0, '', 0, false, 'T', 'M');
...
$pdf->writeHTML('Notes: '.$deliver_instructions , 1, 0, 0, 0, "L");
$pdf->Ln(10);
            ...
            while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)) {
                ...
                $tbl2 .= '
                    <tr>
                        ...
                        <td colspan="2" style="border: 1px solid #737373;">Pack '.$row2['pack_id'] .' - '. $row2['mark'] . ' ' . $row2['qty'] . ' x ' . $row2['qty_unit'] . '</td>
...
<table cellpadding="8" cellspacing="0">
    <tr>
        <td>Signed: ____________________________________</td>
    </tr>
    <tr>
        <td>Name: ____________________________________</td>
    </tr>
    <tr>
        <td>Date: _______/________/_______</td>
    </tr>
    <tr>
        <td><b>Claims for damaged or short delivery must be lodged within 48 hours of delivery.</b></td>
    </tr>
</table>';
