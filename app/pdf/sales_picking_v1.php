...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        if (!$this->header_displayed) { // Only display the header on the first page
            ...
            $this->Cell(0, 15, 'Picking', 0, false, 'R', 0, '', 0, false, 'T', 'M');
...
$tbl2 = '<tr>
        ...
        <td style="border: 1px solid #737373; width: 280px;" color="#000" bgcolor="#ccc">DESCRIPTION</td>
        ...
        <td style="border: 1px solid #737373; width: 70px;" color="#000" bgcolor="#ccc">PICKED</td>
    </tr>';
