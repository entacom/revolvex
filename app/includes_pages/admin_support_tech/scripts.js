var crud_url ='includes_pages/admin_support_tech/crud.php';
var content_url ='includes_pages/admin_support_tech/content.php';

function Loadtab(tab_id) {
	
    $.ajax({
        type: "POST",
        url: "includes_pages/admin_support_tech/content.php",
